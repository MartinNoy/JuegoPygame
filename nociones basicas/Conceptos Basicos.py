...
#        win.blit(s2, (10, 10))#mostrar una superficie predefinida en la ventana
        ...
        pygame.draw.rect(win,azul,r1)#dibuja rectangulos con los parametros pasados pygame.draw.rect(Surface, color, Rect, width=0)
        pygame.draw.rect(win, verde, r2)



##   bucle principal para movimientos
#    imagen1=pygame.image.load("chavon.png")
...
#        player1.mover(vx, vy)
        ...
        (xant,yant)=(r1.left,r1.top)#guardamos la posicion del rectangulo del cursor
        (r1.left,r1.top) = pygame.mouse.get_pos()#hace que el objeto siga el cursor


#       posiciona el curson en el centro del rectangulo
#        r1.left-=r1.width/2#centro de x
#        r1.top-=r1.height/2#centro de y

#       colicion
        if r1.colliderect(r2):
            (r1.left,r1.top)=(xant,yant) #hace que si coliciona vualva a la posicion anterior
